...
public class ProviderMediceneShopActivity extends AppCompatActivity {
    ...
    private void openCamera() throws CameraAccessException {
        ...
        {
            ActivityCompat.requestPermissions(ProviderMediceneShopActivity.this,new String[]{Manifest.permission.CAMERA,Manifest.permission.WRITE_EXTERNAL_STORAGE},101);
            return;
        }
    ...
    private void sendIntent()
    {
        ...
        Intent i = new Intent(this,ProviderConfirmPicture.class);
