...
public class UserMediceneShopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medicene_shop_user);
    ...
    private void openCamera() throws CameraAccessException {
        ...
        {
            ActivityCompat.requestPermissions(UserMediceneShopActivity.this,new String[]{Manifest.permission.CAMERA,Manifest.permission.WRITE_EXTERNAL_STORAGE},101);
            return;
        }
